...
test('glue records api can get all records', function (): void {
    $mockClient = createMockHttpClient([
        [
            'status' => 'SUCCESS',
            'glue' => [
                ['host' => 'ns1', 'ip' => ['192.0.2.1', '192.0.2.2']],
                ['host' => 'ns2', 'ip' => ['192.0.2.3']],
            ],
        ],
    ]);
...
test('glue records api can create record', function (): void {
    ...
    $glueRecords->create('ns1', ['192.0.2.1', '192.0.2.2']);
});
...
test('glue records api can update record', function (): void {
    ...
    $glueRecords->update('ns1', ['192.0.2.3']);
});
