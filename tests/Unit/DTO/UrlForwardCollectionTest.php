...
test('fromArray creates collection from array data', function (): void {
    ...
    expect($urlForwardCollection)->toHaveCount(2)
        ->and($urlForwardCollection->all())->toHaveCount(2)
        ->and($urlForwardCollection->all()[0])->toBeInstanceOf(UrlForward::class)
        ->and($urlForwardCollection->all()[0]->subdomain)->toBe('go');
});
